    ...
    <div className="antialiased min-h-screen relative overflow-x-hidden selection:bg-white/20">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/[0.04] bg-background/50 backdrop-blur-xl">
        ...
        >
          {/* Sliding Content */}
          <div
            className={`absolute inset-0 flex flex-col h-[100dvh] w-full bg-[#030303] transition-transform duration-300 ease-out ${
          ...
          >
            ...
            <div className="flex-1 flex flex-col items-start justify-start space-y-6 p-6 mt-2">
              <Link href="#" className="text-lg font-medium text-muted hover:text-white transition-colors">
                Features
              </Link>
