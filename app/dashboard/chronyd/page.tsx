          ...
          <div className="mt-2 space-y-3 cursor-text" onClick={e => e.stopPropagation()}>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                  <div className="text-[10px] text-muted/70 uppercase tracking-wider font-sans">Request Body</div>
                  <button onClick={(e) => { e.stopPropagation(); onCopy(requestBody, "Request body copied!"); }} className="text-[9px] text-muted hover:text-white flex items-center gap-1 transition-colors">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                  <div className="text-[10px] text-muted/70 uppercase tracking-wider font-sans">Response Body</div>
                  <button onClick={(e) => { e.stopPropagation(); onCopy(responseBody, "Response body copied!"); }} className="text-[9px] text-muted hover:text-white flex items-center gap-1 transition-colors">
                      <Copy className="w-3 h-3" /> Copy
                  </button>
              </div>
              <div className="bg-black/50 border border-white/5 p-2.5 rounded-lg overflow-x-auto custom-scrollbar">
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar flex-1 relative">
              {isModalEditing ? (
                ...
                <>
                  ...
                  <div className="mb-6">
                    <div className="flex items-center gap-3 bg-black/40 border border-white/5 p-3.5 rounded-xl group relative">
                      ...
                      <button 
                          onClick={() => copyToClipboard(detailedJob.url, "URL copied to clipboard!")}
                          className="absolute right-3 opacity-0 group-hover:opacity-100 transition-opacity bg-white/10 hover:bg-white/20 text-white p-1.5 rounded-md"
                          title="Copy URL"
                      >
